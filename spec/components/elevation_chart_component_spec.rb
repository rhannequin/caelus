...
RSpec.describe ElevationChartComponent, type: :component do
  def render_html(elevations:, current_position:, options: {})
    render_inline(
      described_class.new(
  ...
  it "generates valid SVG with elevation data" do
    elevation_points = [
      YearlyElevation::ElevationPoint.new(
        1,
        Date.new(2024, 1, 1),
        Astronoby::Angle.from_degrees(30)
      ),
      YearlyElevation::ElevationPoint.new(
        91,
        Date.new(2024, 4, 1),
        Astronoby::Angle.from_degrees(60)
      ),
      YearlyElevation::ElevationPoint.new(
        182,
        Date.new(2024, 7, 1),
        Astronoby::Angle.from_degrees(75)
      ),
      YearlyElevation::ElevationPoint.new(
        274,
        Date.new(2024, 10, 1),
        Astronoby::Angle.from_degrees(45)
      ),
      YearlyElevation::ElevationPoint.new(
        365,
        Date.new(2024, 12, 31),
        Astronoby::Angle.from_degrees(25)
      )
    ]
    ...
    elevations = instance_double(
      ...
      minimum: elevation_points[4],
      maximum: elevation_points[2]
    )
  ...
  it "marks current position with vertical line and circle" do
    elevation_point = YearlyElevation::ElevationPoint.new(
      100,
      Date.new(2024, 4, 10),
      Astronoby::Angle.from_degrees(65)
    )
  ...
  it "applies custom options when provided" do
    elevation_point = YearlyElevation::ElevationPoint.new(
      1,
      Date.new(2024, 1, 1),
      Astronoby::Angle.from_degrees(40)
    )
    ...
    result = render_html(
      elevations: elevations,
      current_position: elevation_point,
      options: {width: 500, height: 300, colors: {stroke: "#FF0000"}}
    )
  ...
  it "handles empty elevation data" do
    empty_point = YearlyElevation::ElevationPoint.new(
      1,
      Date.new(2024, 1, 1),
      Astronoby::Angle.from_degrees(0)
    )
  ...
  it "generates chart with single elevation point" do
    elevation_point = YearlyElevation::ElevationPoint.new(
      180,
      Date.new(2024, 6, 29),
      Astronoby::Angle.from_degrees(80)
    )
